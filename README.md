...
Lab order management, result ingestion, HL7 v2 Lab ADT
...
git clone https://github.com/zarishsphere/zs-svc-laboratory.git
cd zs-svc-laboratory
...
See [docs.zarishsphere.com/api/zs-svc-laboratory](https://docs.zarishsphere.com/api/zs-svc-laboratory) for the full OpenAPI 3.1 specification.
